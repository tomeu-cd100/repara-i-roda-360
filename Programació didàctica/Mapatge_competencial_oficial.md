# Mapatge competencial amb el currículum oficial — «Repara i Roda 360» (4t ESO)

> **Per a què serveix?** Aquesta optativa fa servir una **codificació pròpia** (CE1–CE6, vegeu
...
- **C3** — Personal, social i d'aprendre a aprendre: autonomia, responsabilitat i regulació
  del propi treball.
- **C5** — Digital: ús d'eines digitals per documentar i comunicar.
- **C6** — Emprenedora i professionalitzadora: aplicació pràctica de tècniques de mecànica i
  fabricació.
- **C8** — Ciutadana i cívica: actitud responsable, cooperació i seguretat viària.
...
Contribució principal (●) i secundària (○):
...
| **Comunicació lingüística (CCL)** | ○ | Diari, vocabulari tècnic, exposició pública |
| **Plurilingüe (CP)** | ○ | Vocabulari anglès de la bicicleta (`Recursos/`) |
| **Consciència i expressió culturals (CCEC)** | ○ | Història de la bicicleta, disseny i identitat del taller |
...
|--------|----------------------------------------|------------|
| Aprenentatge competencial i amb sentit | Bicis reals amb destinatari real (ABP + ApS) | PD §1, §6 |
| Perspectiva de gènere | Rols tècnics per a tothom, referents diversos de mecànica i ciclisme | PD §10 |
| Universalitat del currículum (DUA) | Sessió predictible, fitxes visuals, tempos flexibles, VR anticipatòria | PD §6, §9 |
| Benestar emocional | Èxit tangible, reforç positiu, reconeixement públic (certificat) | PD §1, §9 |
| Ciutadania democràtica i consciència global | ODS, donació comunitària, mobilitat sostenible, seguretat viària | PD §10 |
